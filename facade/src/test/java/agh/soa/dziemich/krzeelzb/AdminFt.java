...
import agh.soa.dziemich.krzeelzb.pages.components.ChipsPage;
import agh.soa.dziemich.krzeelzb.pages.components.DatePickerPage;
import agh.soa.dziemich.krzeelzb.pages.components.DialogPage;
import agh.soa.dziemich.krzeelzb.pages.components.MessagesPage;
import agh.soa.dziemich.krzeelzb.pages.components.SampleFormPage;
import agh.soa.dziemich.krzeelzb.pages.exception.AccessDeniedPage;
import agh.soa.dziemich.krzeelzb.pages.exception.ErrorPage;
import agh.soa.dziemich.krzeelzb.pages.fragments.ControlSidebar;
import agh.soa.dziemich.krzeelzb.pages.fragments.Menu;
import agh.soa.dziemich.krzeelzb.pages.fragments.MenuSearch;
import agh.soa.dziemich.krzeelzb.ultil.DeployUtil;
...
import agh.soa.dziemich.krzeelzb.pages.DataTablePage;
import agh.soa.dziemich.krzeelzb.pages.IndexPage;
import agh.soa.dziemich.krzeelzb.pages.LoginPage;
import agh.soa.dziemich.krzeelzb.pages.exception.ExceptionPage;
import agh.soa.dziemich.krzeelzb.pages.exception.NotFoundPage;
import agh.soa.dziemich.krzeelzb.pages.exception.ViewExpiredPage;
import agh.soa.dziemich.krzeelzb.pages.layout.BreadcrumbPage;
...
public class AdminFt {
    ...
    public void shouldCreateBreadcrumbs(@InitialPage BreadcrumbPage breadcrumbPage) {
        ...
        Assertions.assertThat(messagesPage.getTitle().getText())
    ...
    public void shouldFillSampleForm(@InitialPage SampleFormPage sampleFormPage) {
        Assertions.assertThat(sampleFormPage.getTitle().getText()).contains("Sample page");
    ...
    public void shouldFillLoginDialog(@InitialPage DialogPage dialogPage) {
        Assertions.assertThat(dialogPage.getTitle().getText()).startsWith("Dialog Dialog");
        dialogPage.doLogin();
