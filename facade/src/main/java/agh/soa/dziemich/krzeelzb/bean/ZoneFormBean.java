...
public class ZoneFormBean implements Serializable {
  ...
  public List<Long> getParkometrsIds() throws IOException {
    ...
    Response response = client
        .target("http://127.0.0.1:8080/hr-management-service/hr/subzones/parkometer").request()
        .get();
  ...
  public void addParkometer() {
    ...
    ResteasyWebTarget target = client
        .target("http://127.0.0.1:8080/hr-management-service/hr/subzones/parkometer");
